...
#
# Источник паттерна: pool #010 session-sync-safeguard (pioneer — setka),
# директива brain from-brain/2026-05-30-session-sync-safeguard.md. Логика
# git-агностична — переносима между проектами копированием (пути не зашиты,
# имя репо вычисляется из git toplevel).
