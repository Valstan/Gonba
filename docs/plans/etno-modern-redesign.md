...
🟢 **Plan locked.** Все артефакты в репо. Следующая сессия начинает с **PR1** на машине с рабочим dev-окружением. Перед PR1 пользователь должен:

1. Уточнить финальные русские названия для 3 «slug-only» проектов.
2. Подтвердить набор шрифтов (PT Serif + Manrope + JetBrains Mono) — или предложить альтернативу.
