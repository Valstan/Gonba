          ...
          fields: [
            {
              ...
              admin: {
                description: 'Главная картинка публикации.',
              },
            },
            {
              name: 'content',
              ...
              editor: lexicalEditor({
                features: ({ rootFeatures }) => {
                  return [
                    ...
                    BlocksFeature({ blocks: [Banner, Content, Gallery, Code, MediaBlock] }),
                    FixedToolbarFeature(),
                    InlineToolbarFeature(),
                    HorizontalRuleFeature(),
                  ]
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Похожие посты',
          admin: {
            description: 'Похожие публикации для блока рекомендаций.',
          },
          filterOptions: ({ id }) => {
            return {
              id: {
