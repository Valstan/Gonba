...
export const metadata: Metadata = {
  title: 'Орбита проектов · Гоньба',
  description: 'Интерактивная карта проектов Жемчужины Вятки — orbit-карусель.',
}
    ...
    <main className="homeOrbitPage pb-20 pt-20">
      <section className="container">
        <div className="homeOrbitPage__intro">
          <h1 className="homeOrbitPage__title">Орбита проектов</h1>
          <p className="homeOrbitPage__subtitle">
            Альтернативный вид: интерактивная карта проектов Жемчужины Вятки. В центре — главный проект экопортала.
          </p>
        </div>
